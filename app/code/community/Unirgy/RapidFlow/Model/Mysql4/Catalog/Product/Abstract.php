    ...
    protected function _prepareCategories()
    {
        ...
        if( $rows ) 
        {
            ...
            foreach( $categories as $id => &$c ) 
            {
                if( $noUrlPath ) 
                {
                    $c["url_path"] = $this->catBuildPath($c);
                }
